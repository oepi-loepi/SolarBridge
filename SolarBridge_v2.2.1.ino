/******************************************************************************************
 * SolarBridge v2.2.1 by Oepi-Loepi
 * 
 * 
 * 
...
char GroWattName[40] = "adress@email.com";
char GroWattPass[40] = "GrowattPassword";

char static_ip[18] = "192.168.10.58";
        ...
        if (c == '\n') {                    // if the byte is a newline character
          if (currentLine.length() == 0) {
            ...
            if ((header_web.indexOf("GET /") >= 0) && (header_web.indexOf("GET /reset/") <0)) {
              ...
              client.println("User: " + String(GroWattName) + "<br>");
          ...
          if ((code=200) || (code = 301) || (code = 302)){
                     ...
                     Serial.println(payload); //Print the response payload
                        ...
                        if (!root.success()) {
                            ...
                            ActualPower  = root["powerValue"];
                            float MonthValue  = root["monthValue"];
                            NewDayTotal = root["todayValue"];
